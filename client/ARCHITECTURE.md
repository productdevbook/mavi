...
- `src/components/editor/`, `src/components/mail/`, and future
  `src/features/<domain>/` folders contain domain UI, separated from route
  composition.
...
3. Move one domain at a time into `src/features/<domain>/`.
