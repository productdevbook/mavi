...
function StartTeachingRoute() {
  ...
  return (
    <div className="flex max-w-2xl flex-col gap-6">
      <div>
        <h1 className="text-lg font-semibold">{t`Start teaching`}</h1>
        <p className="text-sm text-muted-foreground">
          {t`A course holds modules and lessons, and people are put on it for as long as you say. Nothing is open to anybody until you say it is.`}
        </p>
      </div>
