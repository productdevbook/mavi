...
pub const OPERATIONS: &[OperationDefinition] = &[
    ...
    OperationDefinition { name: "courses.delete", method: "delete", path: "/api/v1/courses/{id}", request: None, request_location: None, query: None, response: Some("Empty"), response_location: None, status: 204, authentication: "account_or_assistant", capability: Some("courses"), action: Some("delete") },
    ...
    OperationDefinition { name: "courses.students.delete", method: "delete", path: "/api/v1/courses/students/{id}", request: None, request_location: None, query: None, response: Some("Empty"), response_location: None, status: 204, authentication: "account_or_assistant", capability: Some("courses"), action: Some("delete") },
    ...
    OperationDefinition { name: "boards.cards.delete", method: "delete", path: "/api/v1/boards/cards/{id}", request: None, request_location: None, query: None, response: Some("Empty"), response_location: None, status: 204, authentication: "account_or_assistant", capability: Some("boards"), action: Some("delete") },
