...
-- which one a request was for before any of this, and 0050 took the column out
...
-- `domain_checks`, which stays and which 0050 already unscoped.
--
...
--
-- `current_tenant_id()` is read by nothing once 0050's policies are gone, and
