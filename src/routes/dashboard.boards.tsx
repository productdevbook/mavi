...
import type { Board } from "../../server/types/mavicms"
  ...
  return (
    <>
      <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-lg font-semibold">{t`Boards`}</h1>
          <p className="text-sm text-muted-foreground">
            {t`Anything this site works through in order: enquiries, repairs, applications. You name the stages.`}
          </p>
        </div>
      ...
      {boards === null ? (
        ...
        <div className="rounded-xl border border-dashed border-border py-16 text-center">
          ...
          <p className="text-sm text-muted-foreground">{t`No boards yet.`}</p>
        </div>
      ) : (
